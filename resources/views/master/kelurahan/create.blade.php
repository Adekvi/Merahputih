<x-layout.terminal title="Tambah Kelurahan">
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800">Tambah Kelurahan</h2>
    </x-slot>
    ...
    <div class="max-w-3xl mx-auto bg-white dark:bg-gray-900 shadow-lg p-6 rounded-2xl">
        ...
        <form action="{{ route('kelurahan.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="nama_kelurahan" id="nama_kelurahan" 
                       ...
                       class="w-full border rounded-lg px-3 py-2" placeholder="Masukkan nama kelurahan">
            </div>
