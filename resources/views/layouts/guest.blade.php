...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="font-sans antialiased bg-gradient-to-br from-gray-100 via-white to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-all duration-500">

    <div class="min-h-screen flex flex-col lg:flex-row items-center justify-center">
      
      <!-- LEFT PANEL -->
      <div class="flex-1 flex flex-col justify-center items-center w-full max-w-md p-8 bg-white dark:bg-gray-800 shadow-2xl rounded-none lg:rounded-r-3xl z-10">
        <div class="flex flex-col items-center mb-8">
          <a href="/">
            <x-application-logo class="w-16 h-16 text-red-600 dark:text-red-400" />
          </a>
          <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mt-3">{{ config('app.name', 'Laravel') }}</h1>
    ...
    <button id="themeToggle" type="button"
      ...
      <svg id="themeIcon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
